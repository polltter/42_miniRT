...
NAME	= miniRT
CC		= cc
CFLAGS	= -I incs -Imlx -Wall -Werror -Wextra -g3 -O3 -fsanitize=thread #-fsanitize=address -march=native -ffast-math -funsafe-math-optimizations -ffinite-math-only -pthread
